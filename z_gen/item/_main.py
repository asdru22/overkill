...
loot_table_path = path+"datapack/data/ovk/loot_tables/item/" 
lang_path = path+"resourcepack/assets/ovk_lang/lang/en_us.json" 
recipe_path = path+"datapack/data/ovk/functions/gameplay/recipes/"
lang = {}
...
def get_recipe(recipe,id):
    ...
    if(not "shapeless" in recipe):
        ...
        for line in recipe["recipe"]:
            ...
            l+=1
        shaped_str +="} "
        shaped_str += "run loot replace block ~ ~ ~ container.16 loot ovk:item/"+id+"\n\n"
        ...
        shapeless_str +="]} "
        shapeless_str += "run loot replace block ~ ~ ~ container.16 loot ovk:item/"+id+"\n\n"
